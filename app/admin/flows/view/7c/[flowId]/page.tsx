...
export default function View_7cDashboard({ params }: { params: any }) {
  ...
  return (
    <main className="flex flex-col flex-1 min-h-[calc(100vh_-_theme(spacing.16))] gap-4 p-4 md:gap-8 md:p-10">
      ...
      <div>{params.flowId && <p>Flow Id: {params?.templateId}</p>}</div>
